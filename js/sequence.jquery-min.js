  ...
  function t(t, n, r, i) {
    function f() {
      ...
      if (s.settings.preloader)
        if (s.settings.hidePreloaderUsingCSS && s.transitionsSupported) {
          ...
          s.settings.preloader.fadeOut(s.settings.hidePreloaderDelay, function () {
    ...
    function y() {
      ...
      s.nextButton !== undefined &&
        s.nextButton.click(function () {
          s.next();
        });
      s.prevButton !== undefined &&
        s.prevButton.click(function () {
          s.prev();
        });
      s.pauseButton !== undefined &&
        s.pauseButton.click(function () {
          s.pause(!0);
        });
    ...
    var u = { WebkitTransition: "-webkit-", MozTransition: "-moz-", OTransition: "-o-", msTransition: "-ms-", transition: "" },
      a = {
    ...
    (s.paused = function () {}),
      ...
      (s.beforeFirstFrameAnimatesIn = function () {}),
      (s.afterFirstFrameAnimatesIn = function () {}),
      (s.beforeLastFrameAnimatesIn = function () {}),
      (s.afterLastFrameAnimatesIn = function () {}),
  ...
  t.prototype = {
    ...
    goTo: function (e, t) {
      ...
      if (
        ...
        (n.settings.preventReverseSkipping && n.direction !== t && n.active)
      )
        return !1;
          ...
          switch (n.settings.fallback.theme) {
            case "fade":
              ...
              n.currentFrame.animate({ opacity: 0 }, n.settings.fallback.speed, function () {
                ...
                n.beforeNextFrameAnimatesIn();
                n.nextFrame.css({ display: "block", "z-index": n.numberOfFrames }).animate({ opacity: 1 }, 500, function () {
